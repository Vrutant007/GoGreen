          ...
          <div className='container'>
            <div className='row'>
              <div className='col-md-3 py-1'>
                ...
                <div className='pt-3'>An Platform which bring your needs instantly. <br />Powered By:- EZInstaMart</div>
              </div>
              <div className='col-md-3'>
                <h2 className='mb-3'>Categoires</h2>
                <ul>
                  <li>
                    <a href="">Grocery</a>
                  </li>
            ...
            <div className='row py-5'>
              <div className='col-md-4'>
                <div className='d-flex justify-content-center'>
                  ...
                  <h3 className='ps-3'>Free Home Delivery</h3>
                </div>
              </div>
              <div className='col-md-4'>
                <div className='d-flex justify-content-center'>
                  ...
                  <h3 className='ps-3'>Money Back Guarentee</h3>
                </div>
              </div>
              <div className='col-md-4'>
                <div className='d-flex justify-content-center'>
