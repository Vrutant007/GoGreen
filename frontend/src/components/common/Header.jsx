  ...
  return (
    <header className='shadow'>
            <div className='bg-dark text-center py-3'>
                <span className='text-white'>Your Market is nearby NOW!!!</span>
            </div>
                ...
                <Navbar expand="lg" className="">
                    ...
                    <Navbar.Collapse id="navbarScroll">
                            ...
                            <NavDropdown title="Categoies" id="basic-nav-dropdown">
                                {
                                    categories && categories.map(category => {
                                        return (
                                            <NavDropdown.Item href={`/shop?category=${category.id}`}>{category.name}</NavDropdown.Item>
                                        )
                                    })
                                }
                            </NavDropdown>
                        ...
                        <div className='nav-right d-flex'>
                            ...
                            <Link to="/cart" className='cartBucket ms-3'>
                                <div>{getQty()}</div>
