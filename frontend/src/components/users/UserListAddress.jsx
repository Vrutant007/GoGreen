    ...
    const deleteAddress = async(id) => {
        if(confirm('Are you sure you want to delete ?')){
            ...
            .then(result => {
                if(result.status == 200) {
                    console.log(result);
                    const NewAddresses = addressList.filter(addresses => addresses.id != id)
                                ...
                                <tbody>
                                    {addressList.length === 0 ? (
                                        ...
                                        <td colSpan="8" className="text-center text-muted py-3">
                                            No address is registered. Please add your address.
                                        </td>
                                        </tr>
                                    ) : (
                                        addressList.map((address, index) => (
                                            <tr key={index}>
                                                ...
                                                <td>
                                                    <Link to={`/account/edit-address/${address.id}`} className='text-primary'>
                                                    ...
                                                    <Link className='text-danger ms-2' onClick={() => deleteAddress(address.id)}>
