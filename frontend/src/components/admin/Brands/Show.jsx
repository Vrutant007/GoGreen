...
const Show = () => {
    ...
    const deleteBrands = async(id) => {
        if(confirm('Are you sure you want to delete ?')){
            ...
            .then(result => {
                if(result.status == 200){
                    const NewBrands = brand.filter(brand => brand.id != id)
                    setBrands(NewBrands);
                                        ...
                                        brand &&  brand.map(brand => {
                                            return(
                                                <tr>
                                                    ...
                                                    <td>
                                                        {
                                                            brand.status == 1 ? <span className="badge bg-success">Active</span>
                                                    ...
                                                    <td>
                                                        ...
                                                        <Link className='text-danger ms-2' onClick={() => deleteBrands(brand.id)}>
